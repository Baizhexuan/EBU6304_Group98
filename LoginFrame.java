 ...
 * Login verification now uses {@link User#checkPassword(String)} which
 * delegates to SHA-256 hash comparison via {@link PasswordUtil}.
...
public class LoginFrame extends JFrame {
    ...
    public LoginFrame() {
        ...
        JLabel hint = new JLabel(
            ...
            + "Version2 demo accounts: admin/admin123 | ta1/ta123 | ta2/ta456 | mo1/mo123 | mo2/mo456"
    ...
    private void attemptLogin() {
        ...
        // Version2: Give field-specific feedback so test users know what to correct.
        ...
        // Version2: Distinguish invalid username from invalid password for clearer login guidance.
        if (matchedUser == null) {
        ...
        // Version2: verify password against SHA-256 hash instead of plaintext
