...
public class ValidationUtilsTest {
    ...
    public static void main(String[] args) {
        ...
        TestSupport.assertTrue(!ValidationUtils.isEmail("ta@bupt"),
                "Email addresses should include a dotted domain.");
        TestSupport.assertTrue(!ValidationUtils.isEmail("ta..demo@bupt.edu.cn"),
                "Email addresses with repeated dots should be rejected.");
